...
M2 与 M3 可重复对照实验均已完成，结果见 `cycle-01.md`、[M2 记录](sandbox19-focus-order-experiment-2026-09-10.md)和 [M3 记录](sandbox12-team-sharing-experiment-2026-09-10.md)。P1/P2 的玩法设施与闭环已有自然通关和重开证据；2026-09-11 根据作者反馈重新打开视觉收敛，核心构图已改进，资产/材质完成度仍归 P3。P3 的 Windows 独立包、多尺寸、设置及连续回放已验，最终视觉、人工手感/听感、动态窗口及 macOS 仍待完成。M1 与稳定性保留历史证据。
...
- [x] P1 游戏内第一版（功能与核心构图）：代表性场地、镜头、HUD 与选择/指令反馈已实现；2026-09-11 完成相机、场景层次、材质色调和 HUD 比例的结构收敛，实际战斗/命令截图及差异见 [视觉复盘](sandbox19-visual-convergence-2026-09-11.md)。该勾选不表示资产细节已达到目标稿。
- [x] P2 整场体验（玩法闭环）：准备、命令、真实战斗、暂停、结算和重试闭环已验；既有 69.267 秒自然通关及不同部署过程已记录，本轮场景下扩展真实输入回放也在 99.297 秒自然胜利；内部回放与合成 fixture 分开报告。
- [ ] P3 完成度收口：Windows 独立包、720p/1080p、声音设置跨进程保存、后台持续输入回放、截图和视频已交付；旧模块资产/材质与环境细节仍明显低于目标稿，人工持续输入手感/听感、动态窗口调整及 macOS 尚未验，保留明确边界。
