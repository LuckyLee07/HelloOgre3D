...
- [ ] P3 完成度收口：Windows 独立包、720p/1080p、声音设置跨进程保存、持续输入回放、截图、视频及 offscreen 后台窗口已交付或实机验证；本轮又完成 relay 专用门面、场地结构细节、曳光/枪口焰/命中火花、HP 差分受伤反馈，以及 macOS arm64 Release、产品 gate、Sandbox19/6/7/8 smoke 与 720p GL 截图。定制角色/植被与 PBR/后处理仍低于目标稿，人工持续输入手感/扬声器听感和动态窗口调整尚未验，保留明确边界。
