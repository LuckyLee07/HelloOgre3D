...
M2 与 M3 可重复对照实验均已完成，结果见 `cycle-01.md`、[M2 记录](sandbox19-focus-order-experiment-2026-09-10.md)和 [M3 记录](sandbox12-team-sharing-experiment-2026-09-10.md)。P1/P2 的玩法设施与闭环已有自然通关和重开证据；2026-09-11 的相机/HUD、荒漠环境、relay 专用门面和战斗/受伤反馈均已完成实机收口，2026-09-12 又补齐地表旧化、接触阴影、定制荒漠植被，以及场景色调与 UI 合成隔离。P3 的 Windows 独立包、多尺寸、设置、连续回放、后台窗口以及 macOS arm64 Release/720p GL 运行已验；定制角色与 PBR 高阶材质、人工手感/扬声器听感和动态窗口仍待完成。M1 与稳定性保留历史证据。
...
- [ ] P3 完成度收口：Windows 独立包、720p/1080p、声音设置跨进程保存、持续输入回放、截图、视频及 offscreen 后台窗口已交付或实机验证；本轮又完成 relay 专用门面、场地结构细节、地表旧化、接触阴影、定制荒漠植被、克制的场景色调与 UI 合成隔离、曳光/枪口焰/命中火花、HP 差分受伤反馈，以及 macOS arm64 Release、产品 gate、Sandbox19/6/7/8 smoke、FairyGUI All 自测与 720p GL 截图。定制角色与 PBR 高阶材质仍低于目标稿，人工持续输入手感/扬声器听感和动态窗口调整尚未验，保留明确边界。
