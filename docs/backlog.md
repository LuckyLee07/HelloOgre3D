...
M2 与 M3 可重复对照实验均已完成，结果见 `cycle-01.md`、[M2 记录](sandbox19-focus-order-experiment-2026-09-10.md)和 [M3 记录](sandbox12-team-sharing-experiment-2026-09-10.md)。P1/P2 的玩法设施与闭环已有自然通关和重开证据；2026-09-11 的相机/HUD 收敛与荒漠环境深化均已完成实机验收。P3 的 Windows 独立包、多尺寸、设置、连续回放与虚拟桌面外后台窗口已验；定制资产/PBR 细节、人工手感/听感、动态窗口及 macOS 仍待完成。M1 与稳定性保留历史证据。
...
- [ ] P3 完成度收口：Windows 独立包、720p/1080p、声音设置跨进程保存、持续输入回放、截图、视频及 offscreen 后台窗口已交付或实机验证；定制角色/建筑/植被与 PBR 材质仍低于目标稿，人工持续输入手感/听感、动态窗口调整及 macOS 尚未验，保留明确边界。
