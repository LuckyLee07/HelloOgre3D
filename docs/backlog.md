...
2026-09-13 人工验收入口：最新本地包的签名、ZIP、资源哈希和包内后台 GL 抓帧通过，附真人键鼠/扬声器清单；真人与 Windows 仍为 NOT RUN，后续角色、环境、阴影按[分轮记录](dev-design/plans/2026-09-13-sandbox19-p3-iteration.md)推进，P3 未勾选。
