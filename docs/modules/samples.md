...
- Sandbox19 显式配置 FOLLOW 相机（距离 6.5、高 3.2、前视 0、眼高 1.5，滚轮距离范围 5.5–11），并启用相机平面 WASD 移动、Q/E 镜头偏航；控制器退出 FOLLOW 时重置 profile，其他 sample 保留原默认控制。详见 [[runtime]]。
...
- 当前验收边界：Windows Release 全量重编、Lua 5.1 语法、强化产品 fixture，以及独立包 69.267 秒自然通关、重开/正常退出、720p/1080p 与设置保存已有证据，见[本轮验收](../playtest-relay-2026-09-10.md)。2026-09-11 又完成 macOS arm64 Release、产品 fixture、Sandbox19/6/7/8 smoke 与 720p GL 视觉抓帧，见[视觉复盘](../sandbox19-visual-convergence-2026-09-11.md)。当前机器缺 Lua 5.1 可执行文件，本轮三个脚本仅由 luac 5.3 解析并由游戏内嵌 Lua 5.1 实际运行；人工外部输入、扬声器听感、动态窗口及 macOS 1080p 仍未验证，不据此宣称 P3 全部验收完成。
