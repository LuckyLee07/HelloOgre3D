...
- 待：G6 黑板类型扩展；G7 已有条件缓存/脏 key、BT frame budget 与 distance LOD 第一切片，后续补更通用的节点缓存和实例池。`docs/design/behavior-tree-gap-analysis.md`、`docs/archive/ai-technical-iteration-plan.md`。
