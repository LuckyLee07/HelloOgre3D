...
- [每轮完成后直接本地提交](iteration-local-commit-authorization.md) — 2026-09-19 作者持续授权：升级轮次完成并验证后直接提交，无需逐次提醒；默认不 push

- [作者试玩与产品完成度反馈](playtest-product-quality-20260919.md) — 2026-09-19 整体体验未获认可；射击/指挥均可，要求场景美术与玩法同步升级，已授权双机方案升级，首个样段不等于整体体验已认可
