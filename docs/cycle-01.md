...
2026-09-13 另将 A1 标识及续办记录独立提交为 `5a6979f`，并准备最新 macOS 本地试玩包：包内资源哈希、签名、ZIP 完整性和包内后台 GL 启动抓帧通过，附实际键鼠、Alt 下令、失焦重捕和扬声器核对清单。后台回放没有物理输入或听感证据，真人与 Windows 仍为 NOT RUN，P3 不关闭；见[分轮体验记录](dev-design/plans/2026-09-13-sandbox19-p3-iteration.md)。
