...
>
> 边界：本文关注 C++ 对象关系、职责边界、所有权、命名和绑定方式。目录结构、FGUI 专项能力、AI 专项能力分别参考 `docs/archive/project-roadmap.md`、`docs/fgui/fairygui-final-roadmap.md`、`docs/planning/ai-roadmap.md`。
...
- [x] 新增本文档，并在 `docs/archive/project-roadmap.md` 的对象系统组件化条目中指向本文档。
