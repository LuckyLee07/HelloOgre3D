...
SamplePresets.bt_runtime_lod.behaviorTree.distanceLodNear = 0
SamplePresets.bt_runtime_lod.behaviorTree.distanceLodFar = 1
SamplePresets.bt_runtime_lod.behaviorTree.distanceLodMaxMultiplier = 4
...
SamplePresets.bt_runtime_rebuild = cloneTable(SamplePresets.chapter8_perception)
SamplePresets.bt_runtime_rebuild.behaviorTree.tickIntervalMs = 250
SamplePresets.bt_runtime_rebuild.behaviorTree.tickStagger = false
SamplePresets.bt_runtime_rebuild.behaviorTree.traceSampleInterval = 2
SamplePresets.bt_runtime_rebuild.behaviorTree.rebuildSelfTest = true
SamplePresets.bt_runtime_rebuild.diagnostics = {
	maxObjects = 8,
	maxResources = 6,
	maxEvents = 8,
}

SamplePresets.bt_hot_reload = cloneTable(SamplePresets.chapter8_perception)
SamplePresets.bt_hot_reload.behaviorTree.tickIntervalMs = 250
SamplePresets.bt_hot_reload.behaviorTree.tickStagger = false
SamplePresets.bt_hot_reload.behaviorTree.traceSampleInterval = 2
SamplePresets.bt_hot_reload.behaviorTree.hotReloadSelfTest = true
SamplePresets.bt_hot_reload.diagnostics = {
	maxObjects = 8,
	maxResources = 6,
	maxEvents = 8,
}
...
SamplePresets.chapter9_tactics_legacy_parity.chapter9Tactics.legacyEventBridgeSelfTest = true
...
SamplePresets.chapter9_tactics_cpp.chapter9Tactics.dangerDrawYOffset = 0.18
SamplePresets.chapter9_tactics_cpp.chapter9Tactics.dangerDrawThreshold = 0.10
SamplePresets.chapter9_tactics_cpp.chapter9Tactics.dangerDrawMaxCells = 96
SamplePresets.chapter9_tactics_cpp.chapter9Tactics.dangerProjectToNav = true
SamplePresets.chapter9_tactics_cpp.chapter9Tactics.dangerDrawNavProjectionMaxDistance = 3.6
SamplePresets.chapter9_tactics_cpp.chapter9Tactics.dangerDrawNavMeshName = "default"
