...
Soldier.States = {
    SSTATE_DEAD = SSTATE_DEAD,
    SSTATE_FIRE = SSTATE_FIRE,
    SSTATE_IDLE_AIM = SSTATE_IDLE_AIM,
    SSTATE_RUN_FORWARD = SSTATE_RUN_FORWARD,
    SSTATE_RUN_BACKWARD = SSTATE_RUN_BACKWARD,
    SSTATE_DEAD_HEADSHOT = SSTATE_DEAD_HEADSHOT,
    SSTATE_FALL_DEAD = SSTATE_FALL_DEAD,
    SSTATE_FALL_IDLE = SSTATE_FALL_IDLE,
    SSTATE_JUMP_LAND = SSTATE_JUMP_LAND,
    SSTATE_JUMP_UP = SSTATE_JUMP_UP,
    SSTATE_MELEE = SSTATE_MELEE,
    SSTATE_RELOAD = SSTATE_RELOAD,
    SSTATE_SMG_TRANSFORM = SSTATE_SMG_TRANSFORM,
...
function Soldier_InitSoldierAsm(agent)
    ...
    soldierAsm:AddTransition("crouch_fire", "crouch_forward", 0.5, 0.15);
    ...
    soldierAsm:AddTransition("crouch_fire", "run_forward", 0.5, 0.15);
    ...
    soldierAsm:AddTransition("fire", "run_forward", 0.5, 0.15);
    soldierAsm:AddTransition("fire", "run_backward", 0.5, 0.15);
    soldierAsm:AddTransition("fire", "crouch_idle_aim", 0.5, 0.5);
    soldierAsm:AddTransition("fire", "crouch_fire", 0.3, 0.3);
    soldierAsm:AddTransition("fire", "crouch_forward", 0.5, 0.15);
