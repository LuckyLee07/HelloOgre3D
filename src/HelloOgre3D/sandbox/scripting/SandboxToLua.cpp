...
** Generated automatically by tolua++-1.0.92 on Sat Jun 20 21:58:38 2026.
*/
...
static void tolua_reg_types (lua_State* tolua_S)
{
 ...
 tolua_usertype(tolua_S,"TeamBlackboardService");
 ...
 tolua_usertype(tolua_S,"NavigationService");
...
/* method: SetUseCppFsmFlag of class  AgentConfigService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentConfigService_SetUseCppFsmFlag00
static int tolua_SandboxToLua_AgentConfigService_SetUseCppFsmFlag00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"AgentConfigService",0,&tolua_err) ||
     !tolua_isboolean(tolua_S,2,0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
...
#endif
 {
  AgentConfigService* self = (AgentConfigService*)  tolua_tousertype(tolua_S,1,0);
...
/* method: GetUseCppFsmFlag of class  AgentConfigService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentConfigService_GetUseCppFsmFlag00
static int tolua_SandboxToLua_AgentConfigService_GetUseCppFsmFlag00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const AgentConfigService",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  const AgentConfigService* self = (const AgentConfigService*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'GetUseCppFsmFlag'", NULL);
#endif
  {
   bool tolua_ret = (bool)  self->GetUseCppFsmFlag();
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'GetUseCppFsmFlag'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: DefaultConfig of class  NavigationService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_NavigationService_DefaultConfig00
static int tolua_SandboxToLua_NavigationService_DefaultConfig00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"NavigationService",0,&tolua_err) ||
...
#endif
 {
  NavigationService* self = (NavigationService*)  tolua_tousertype(tolua_S,1,0);
...
/* method: ApplySettingConfig of class  NavigationService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_NavigationService_ApplySettingConfig00
static int tolua_SandboxToLua_NavigationService_ApplySettingConfig00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: CreateNavigationMesh of class  NavigationService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_NavigationService_CreateNavigationMesh00
static int tolua_SandboxToLua_NavigationService_CreateNavigationMesh00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: RandomPoint of class  NavigationService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_NavigationService_RandomPoint00
static int tolua_SandboxToLua_NavigationService_RandomPoint00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const NavigationService",0,&tolua_err) ||
     !tolua_iscppstring(tolua_S,2,0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
...
#endif
 {
  const NavigationService* self = (const NavigationService*)  tolua_tousertype(tolua_S,1,0);
...
/* method: FindClosestPoint of class  NavigationService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_NavigationService_FindClosestPoint00
static int tolua_SandboxToLua_NavigationService_FindClosestPoint00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: FindPath of class  NavigationService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_NavigationService_FindPath00
static int tolua_SandboxToLua_NavigationService_FindPath00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: RayCastObjectId of class  RaycastService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_RaycastService_RayCastObjectId00
static int tolua_SandboxToLua_RaycastService_RayCastObjectId00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const RaycastService",0,&tolua_err) ||
...
#endif
 {
  const RaycastService* self = (const RaycastService*)  tolua_tousertype(tolua_S,1,0);
...
static int tolua_SandboxToLua_SceneService_SetSkyBox00(lua_State* tolua_S)
{
 ...
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"SceneService",0,&tolua_err) ||
     !tolua_iscppstring(tolua_S,2,0,&tolua_err) ||
     (tolua_isvaluenil(tolua_S,3,&tolua_err) || !tolua_isusertype(tolua_S,3,"const Ogre::Vector3",0,&tolua_err)) ||
     !tolua_isnoobj(tolua_S,4,&tolua_err)
 )
...
#endif
 {
  SceneService* self = (SceneService*)  tolua_tousertype(tolua_S,1,0);
...
/* method: SetAmbientLight of class  SceneService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_SceneService_SetAmbientLight00
static int tolua_SandboxToLua_SceneService_SetAmbientLight00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: CreateDirectionalLight of class  SceneService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_SceneService_CreateDirectionalLight00
static int tolua_SandboxToLua_SceneService_CreateDirectionalLight00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
 ...
 {
  SceneService* self = (SceneService*)  tolua_tousertype(tolua_S,1,0);
  const Ogre::Vector3* direction = ((const Ogre::Vector3*)  tolua_tousertype(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'CreateDirectionalLight'", NULL);
#endif
  {
   Ogre::Light* tolua_ret = (Ogre::Light*)  self->CreateDirectionalLight(*direction);
...
/* method: setMaterial of class  SceneService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_SceneService_setMaterial01
static int tolua_SandboxToLua_SceneService_setMaterial01(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"SceneService",0,&tolua_err) ||
 ...
 return 1;
tolua_lerror:
 return tolua_SandboxToLua_SceneService_setMaterial00(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE

/* method: UpdateSceneGraph of class  SceneService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_SceneService_UpdateSceneGraph00
static int tolua_SandboxToLua_SceneService_UpdateSceneGraph00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: CallFile of class  ScriptService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_ScriptService_CallFile00
static int tolua_SandboxToLua_ScriptService_CallFile00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"ScriptService",0,&tolua_err) ||
     !tolua_iscppstring(tolua_S,2,0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
...
#endif
 {
  ScriptService* self = (ScriptService*)  tolua_tousertype(tolua_S,1,0);
...
/* method: SetPosition of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_SetPosition00
static int tolua_SandboxToLua_AgentLocomotion_SetPosition00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"AgentLocomotion",0,&tolua_err) ||
     (tolua_isvaluenil(tolua_S,2,&tolua_err) || !tolua_isusertype(tolua_S,2,"const Ogre::Vector3",0,&tolua_err)) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
...
#endif
 {
  AgentLocomotion* self = (AgentLocomotion*)  tolua_tousertype(tolua_S,1,0);
...
/* method: GetPosition of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetPosition00
static int tolua_SandboxToLua_AgentLocomotion_GetPosition00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const AgentLocomotion",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  const AgentLocomotion* self = (const AgentLocomotion*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
/* method: SetMass of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_SetMass00
static int tolua_SandboxToLua_AgentLocomotion_SetMass00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: SetHeight of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_SetHeight00
static int tolua_SandboxToLua_AgentLocomotion_SetHeight00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: SetRadius of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_SetRadius00
static int tolua_SandboxToLua_AgentLocomotion_SetRadius00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: SetSpeed of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_SetSpeed00
static int tolua_SandboxToLua_AgentLocomotion_SetSpeed00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: SetMaxForce of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_SetMaxForce00
static int tolua_SandboxToLua_AgentLocomotion_SetMaxForce00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: SetMaxSpeed of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_SetMaxSpeed00
static int tolua_SandboxToLua_AgentLocomotion_SetMaxSpeed00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetMass of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetMass00
static int tolua_SandboxToLua_AgentLocomotion_GetMass00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetSpeed of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetSpeed00
static int tolua_SandboxToLua_AgentLocomotion_GetSpeed00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetHeight of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetHeight00
static int tolua_SandboxToLua_AgentLocomotion_GetHeight00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetRadius of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetRadius00
static int tolua_SandboxToLua_AgentLocomotion_GetRadius00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetMaxForce of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetMaxForce00
static int tolua_SandboxToLua_AgentLocomotion_GetMaxForce00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetMaxSpeed of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetMaxSpeed00
static int tolua_SandboxToLua_AgentLocomotion_GetMaxSpeed00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: SetForward of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_SetForward00
static int tolua_SandboxToLua_AgentLocomotion_SetForward00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: SetTarget of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_SetTarget00
static int tolua_SandboxToLua_AgentLocomotion_SetTarget00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: SetTargetRadius of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_SetTargetRadius00
static int tolua_SandboxToLua_AgentLocomotion_SetTargetRadius00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetTargetRadius of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetTargetRadius00
static int tolua_SandboxToLua_AgentLocomotion_GetTargetRadius00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetTarget of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetTarget00
static int tolua_SandboxToLua_AgentLocomotion_GetTarget00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetVelocity of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetVelocity00
static int tolua_SandboxToLua_AgentLocomotion_GetVelocity00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetUp of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetUp00
static int tolua_SandboxToLua_AgentLocomotion_GetUp00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetLeft of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetLeft00
static int tolua_SandboxToLua_AgentLocomotion_GetLeft00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetForward of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetForward00
static int tolua_SandboxToLua_AgentLocomotion_GetForward00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: SetPath of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_SetPath00
static int tolua_SandboxToLua_AgentLocomotion_SetPath00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetPath of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetPath00
static int tolua_SandboxToLua_AgentLocomotion_GetPath00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: HasPath of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_HasPath00
static int tolua_SandboxToLua_AgentLocomotion_HasPath00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: IsPathCyclic of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_IsPathCyclic00
static int tolua_SandboxToLua_AgentLocomotion_IsPathCyclic00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const AgentLocomotion* self = (const AgentLocomotion*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'IsPathCyclic'", NULL);
#endif
  {
   bool tolua_ret = (bool)  self->IsPathCyclic();
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'IsPathCyclic'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: GetDistanceAlongPath of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetDistanceAlongPath00
static int tolua_SandboxToLua_AgentLocomotion_GetDistanceAlongPath00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetNearestPointOnPath of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetNearestPointOnPath00
static int tolua_SandboxToLua_AgentLocomotion_GetNearestPointOnPath00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetPointOnPath of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_GetPointOnPath00
static int tolua_SandboxToLua_AgentLocomotion_GetPointOnPath00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: ForceToPosition of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_ForceToPosition00
static int tolua_SandboxToLua_AgentLocomotion_ForceToPosition00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: ForceToFollowPath of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_ForceToFollowPath00
static int tolua_SandboxToLua_AgentLocomotion_ForceToFollowPath00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: ForceToStayOnPath of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_ForceToStayOnPath00
static int tolua_SandboxToLua_AgentLocomotion_ForceToStayOnPath00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: ForceToWander of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_ForceToWander00
static int tolua_SandboxToLua_AgentLocomotion_ForceToWander00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: ForceToTargetSpeed of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_ForceToTargetSpeed00
static int tolua_SandboxToLua_AgentLocomotion_ForceToTargetSpeed00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: ForceToAvoidAgents of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_ForceToAvoidAgents00
static int tolua_SandboxToLua_AgentLocomotion_ForceToAvoidAgents00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: ForceToAvoidObjects of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_ForceToAvoidObjects00
static int tolua_SandboxToLua_AgentLocomotion_ForceToAvoidObjects00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: ForceToCombine of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_ForceToCombine00
static int tolua_SandboxToLua_AgentLocomotion_ForceToCombine00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: ForceToSeparate of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_ForceToSeparate00
static int tolua_SandboxToLua_AgentLocomotion_ForceToSeparate00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: ApplyForce of class  AgentLocomotion */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentLocomotion_ApplyForce00
static int tolua_SandboxToLua_AgentLocomotion_ApplyForce00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: EnterIdleIntent of class  AnimComponent */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AnimComponent_EnterIdleIntent00
static int tolua_SandboxToLua_AnimComponent_EnterIdleIntent00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  AnimComponent* self = (AnimComponent*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'EnterIdleIntent'", NULL);
#endif
  {
   bool tolua_ret = (bool)  self->EnterIdleIntent();
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'EnterIdleIntent'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: EnterMoveIntent of class  AnimComponent */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AnimComponent_EnterMoveIntent00
static int tolua_SandboxToLua_AnimComponent_EnterMoveIntent00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  AnimComponent* self = (AnimComponent*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'EnterMoveIntent'", NULL);
#endif
  {
   bool tolua_ret = (bool)  self->EnterMoveIntent();
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'EnterMoveIntent'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: EnterShootIntent of class  AnimComponent */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AnimComponent_EnterShootIntent00
static int tolua_SandboxToLua_AnimComponent_EnterShootIntent00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  AnimComponent* self = (AnimComponent*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'EnterShootIntent'", NULL);
#endif
  {
   bool tolua_ret = (bool)  self->EnterShootIntent();
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'EnterShootIntent'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: EnterReloadIntent of class  AnimComponent */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AnimComponent_EnterReloadIntent00
static int tolua_SandboxToLua_AnimComponent_EnterReloadIntent00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  AnimComponent* self = (AnimComponent*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'EnterReloadIntent'", NULL);
#endif
  {
   bool tolua_ret = (bool)  self->EnterReloadIntent();
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'EnterReloadIntent'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: EnterDeathIntent of class  AnimComponent */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AnimComponent_EnterDeathIntent00
static int tolua_SandboxToLua_AnimComponent_EnterDeathIntent00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  AnimComponent* self = (AnimComponent*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'EnterDeathIntent'", NULL);
#endif
  {
   bool tolua_ret = (bool)  self->EnterDeathIntent();
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'EnterDeathIntent'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: GetLocomotionComponent of class  BaseObject */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_BaseObject_GetLocomotionComponent00
static int tolua_SandboxToLua_BaseObject_GetLocomotionComponent00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  BaseObject* self = (BaseObject*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'GetLocomotionComponent'", NULL);
#endif
  {
   AgentLocomotion* tolua_ret = (AgentLocomotion*)  self->GetLocomotionComponent();
    tolua_pushusertype(tolua_S,(void*)tolua_ret,"AgentLocomotion");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'GetLocomotionComponent'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: GetAgentOwner of class  AIController */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AIController_GetAgentOwner00
static int tolua_SandboxToLua_AIController_GetAgentOwner00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: CreateVisualPlane of class  ObjectFactory */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_ObjectFactory_CreateVisualPlane00
static int tolua_SandboxToLua_ObjectFactory_CreateVisualPlane00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  float height = ((float)  tolua_tonumber(tolua_S,3,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'CreateVisualPlane'", NULL);
#endif
  {
   BlockObject* tolua_ret = (BlockObject*)  self->CreateVisualPlane(width,height);
    tolua_pushusertype(tolua_S,(void*)tolua_ret,"BlockObject");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'CreateVisualPlane'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: CreateAgentWithProfile of class  ObjectFactory */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_ObjectFactory_CreateAgentWithProfile00
static int tolua_SandboxToLua_ObjectFactory_CreateAgentWithProfile00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'CreateAgentWithProfile'", NULL);
#endif
  {
   AgentObject* tolua_ret = (AgentObject*)  self->CreateAgentWithProfile(agentType,profileName,filepath);
    tolua_pushusertype(tolua_S,(void*)tolua_ret,"AgentObject");
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'CreateAgentWithProfile'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_SandboxToLua_AIScheduler_configureAiScheduler00(lua_State* tolua_S)
{
 ...
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"AIScheduler",0,&tolua_err) ||
     !tolua_isboolean(tolua_S,2,0,&tolua_err) ||
     !tolua_isnumber(tolua_S,3,0,&tolua_err) ||
     !tolua_isnumber(tolua_S,4,0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,5,&tolua_err)
...
#endif
 {
  AIScheduler* self = (AIScheduler*)  tolua_tousertype(tolua_S,1,0);
...
/* method: buildAiSchedulerDebugSummary of class  AIScheduler */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AIScheduler_buildAiSchedulerDebugSummary00
static int tolua_SandboxToLua_AIScheduler_buildAiSchedulerDebugSummary00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const AIScheduler",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  const AIScheduler* self = (const AIScheduler*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
/* method: configureHearingDangerSense of class  AgentPerceptionSystem */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentPerceptionSystem_configureHearingDangerSense00
static int tolua_SandboxToLua_AgentPerceptionSystem_configureHearingDangerSense00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"AgentPerceptionSystem",0,&tolua_err) ||
     !tolua_isboolean(tolua_S,2,0,&tolua_err) ||
     !tolua_isnumber(tolua_S,3,0,&tolua_err) ||
     !tolua_isnumber(tolua_S,4,0,&tolua_err) ||
     !tolua_isnumber(tolua_S,5,0,&tolua_err) ||
...
#endif
 {
  AgentPerceptionSystem* self = (AgentPerceptionSystem*)  tolua_tousertype(tolua_S,1,0);
  bool enabled = ((bool)  tolua_toboolean(tolua_S,2,0));
  int scanIntervalMs = ((int)  tolua_tonumber(tolua_S,3,0));
  int agentsPerTick = ((int)  tolua_tonumber(tolua_S,4,0));
  int responseCooldownMs = ((int)  tolua_tonumber(tolua_S,5,0));
  int dangerCooldownMs = ((int)  tolua_tonumber(tolua_S,6,0));
  float investigateStopDistance = ((float)  tolua_tonumber(tolua_S,7,0));
  float escapeDistance = ((float)  tolua_tonumber(tolua_S,8,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'configureHearingDangerSense'", NULL);
#endif
  {
   self->configureHearingDangerSense(enabled,scanIntervalMs,agentsPerTick,responseCooldownMs,dangerCooldownMs,investigateStopDistance,escapeDistance);
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'configureHearingDangerSense'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: clearHearingDangerSense of class  AgentPerceptionSystem */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentPerceptionSystem_clearHearingDangerSense00
static int tolua_SandboxToLua_AgentPerceptionSystem_clearHearingDangerSense00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  AgentPerceptionSystem* self = (AgentPerceptionSystem*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'clearHearingDangerSense'", NULL);
#endif
  {
   self->clearHearingDangerSense();
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'clearHearingDangerSense'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: publishHearingDangerEvent of class  AgentPerceptionSystem */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentPerceptionSystem_publishHearingDangerEvent00
static int tolua_SandboxToLua_AgentPerceptionSystem_publishHearingDangerEvent00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
 ...
 {
  AgentPerceptionSystem* self = (AgentPerceptionSystem*)  tolua_tousertype(tolua_S,1,0);
  int sourceId = ((int)  tolua_tonumber(tolua_S,2,0));
  int sourceTeamId = ((int)  tolua_tonumber(tolua_S,3,0));
  int targetId = ((int)  tolua_tonumber(tolua_S,4,0));
  const Ogre::Vector3* position = ((const Ogre::Vector3*)  tolua_tousertype(tolua_S,5,0));
  const Ogre::Vector3* impactPosition = ((const Ogre::Vector3*)  tolua_tousertype(tolua_S,6,0));
  int timeMs = ((int)  tolua_tonumber(tolua_S,7,0));
  int ttlMs = ((int)  tolua_tonumber(tolua_S,8,0));
  float hearingRadius = ((float)  tolua_tonumber(tolua_S,9,0));
  float dangerRadius = ((float)  tolua_tonumber(tolua_S,10,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'publishHearingDangerEvent'", NULL);
#endif
  {
   bool tolua_ret = (bool)  self->publishHearingDangerEvent(sourceId,sourceTeamId,targetId,*position,*impactPosition,timeMs,ttlMs,hearingRadius,dangerRadius);
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'publishHearingDangerEvent'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getHearingDangerEventCount of class  AgentPerceptionSystem */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerEventCount00
static int tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerEventCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const AgentPerceptionSystem",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  const AgentPerceptionSystem* self = (const AgentPerceptionSystem*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getHearingDangerEventCount'", NULL);
#endif
  {
   int tolua_ret = (int)  self->getHearingDangerEventCount();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getHearingDangerEventCount'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getHearingDangerPublishedEventCount of class  AgentPerceptionSystem */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerPublishedEventCount00
static int tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerPublishedEventCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const AgentPerceptionSystem* self = (const AgentPerceptionSystem*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getHearingDangerPublishedEventCount'", NULL);
#endif
  {
   int tolua_ret = (int)  self->getHearingDangerPublishedEventCount();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getHearingDangerPublishedEventCount'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getHearingDangerPrunedEventCount of class  AgentPerceptionSystem */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerPrunedEventCount00
static int tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerPrunedEventCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const AgentPerceptionSystem* self = (const AgentPerceptionSystem*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getHearingDangerPrunedEventCount'", NULL);
#endif
  {
   int tolua_ret = (int)  self->getHearingDangerPrunedEventCount();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getHearingDangerPrunedEventCount'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getHearingDangerRunCount of class  AgentPerceptionSystem */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerRunCount00
static int tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerRunCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const AgentPerceptionSystem* self = (const AgentPerceptionSystem*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getHearingDangerRunCount'", NULL);
#endif
  {
   int tolua_ret = (int)  self->getHearingDangerRunCount();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getHearingDangerRunCount'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getHearingDangerSkipCount of class  AgentPerceptionSystem */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerSkipCount00
static int tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerSkipCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const AgentPerceptionSystem* self = (const AgentPerceptionSystem*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getHearingDangerSkipCount'", NULL);
#endif
  {
   int tolua_ret = (int)  self->getHearingDangerSkipCount();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getHearingDangerSkipCount'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getHearingDangerAgentCheckCount of class  AgentPerceptionSystem */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerAgentCheckCount00
static int tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerAgentCheckCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const AgentPerceptionSystem* self = (const AgentPerceptionSystem*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getHearingDangerAgentCheckCount'", NULL);
#endif
  {
   int tolua_ret = (int)  self->getHearingDangerAgentCheckCount();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getHearingDangerAgentCheckCount'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getHearingDangerHeardResponseCount of class  AgentPerceptionSystem */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerHeardResponseCount00
static int tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerHeardResponseCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const AgentPerceptionSystem* self = (const AgentPerceptionSystem*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getHearingDangerHeardResponseCount'", NULL);
#endif
  {
   int tolua_ret = (int)  self->getHearingDangerHeardResponseCount();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getHearingDangerHeardResponseCount'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getHearingDangerDangerResponseCount of class  AgentPerceptionSystem */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerDangerResponseCount00
static int tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerDangerResponseCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const AgentPerceptionSystem* self = (const AgentPerceptionSystem*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getHearingDangerDangerResponseCount'", NULL);
#endif
  {
   int tolua_ret = (int)  self->getHearingDangerDangerResponseCount();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getHearingDangerDangerResponseCount'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getHearingDangerInvestigationCount of class  AgentPerceptionSystem */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerInvestigationCount00
static int tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerInvestigationCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const AgentPerceptionSystem* self = (const AgentPerceptionSystem*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getHearingDangerInvestigationCount'", NULL);
#endif
  {
   int tolua_ret = (int)  self->getHearingDangerInvestigationCount();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getHearingDangerInvestigationCount'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getHearingDangerRetreatFactApplyCount of class  AgentPerceptionSystem */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerRetreatFactApplyCount00
static int tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerRetreatFactApplyCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const AgentPerceptionSystem* self = (const AgentPerceptionSystem*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getHearingDangerRetreatFactApplyCount'", NULL);
#endif
  {
   int tolua_ret = (int)  self->getHearingDangerRetreatFactApplyCount();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getHearingDangerRetreatFactApplyCount'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: buildPerceptionDebugSummary of class  AgentPerceptionSystem */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_AgentPerceptionSystem_buildPerceptionDebugSummary00
static int tolua_SandboxToLua_AgentPerceptionSystem_buildPerceptionDebugSummary00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const AgentPerceptionSystem* self = (const AgentPerceptionSystem*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'buildPerceptionDebugSummary'", NULL);
#endif
  {
   std::string tolua_ret = (std::string)  self->buildPerceptionDebugSummary();
   tolua_pushcppstring(tolua_S,(const char*)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'buildPerceptionDebugSummary'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: clearTeamBlackboardFacts of class  TeamBlackboardService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TeamBlackboardService_clearTeamBlackboardFacts00
static int tolua_SandboxToLua_TeamBlackboardService_clearTeamBlackboardFacts00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: configureTeamBlackboard of class  TeamBlackboardService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TeamBlackboardService_configureTeamBlackboard00
static int tolua_SandboxToLua_TeamBlackboardService_configureTeamBlackboard00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: rememberTeamFact of class  TeamBlackboardService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TeamBlackboardService_rememberTeamFact00
static int tolua_SandboxToLua_TeamBlackboardService_rememberTeamFact00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
 ...
 {
  TeamBlackboardService* self = (TeamBlackboardService*)  tolua_tousertype(tolua_S,1,0);
  const std::string factType = ((const std::string)  tolua_tocppstring(tolua_S,2,0));
  int teamId = ((int)  tolua_tonumber(tolua_S,3,0));
  int sourceAgentId = ((int)  tolua_tonumber(tolua_S,4,0));
  int targetAgentId = ((int)  tolua_tonumber(tolua_S,5,0));
  const Ogre::Vector3* position = ((const Ogre::Vector3*)  tolua_tousertype(tolua_S,6,0));
  int timeMs = ((int)  tolua_tonumber(tolua_S,7,0));
  float confidence = ((float)  tolua_tonumber(tolua_S,8,0));
  int priority = ((int)  tolua_tonumber(tolua_S,9,0));
  int ttlMs = ((int)  tolua_tonumber(tolua_S,10,0));
  const std::string key = ((const std::string)  tolua_tocppstring(tolua_S,11,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'rememberTeamFact'", NULL);
#endif
  {
   bool tolua_ret = (bool)  self->rememberTeamFact(factType,teamId,sourceAgentId,targetAgentId,*position,timeMs,confidence,priority,ttlMs,key);
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'rememberTeamFact'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: writeBestTeamEnemyFactToBlackboard of class  TeamBlackboardService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TeamBlackboardService_writeBestTeamEnemyFactToBlackboard00
static int tolua_SandboxToLua_TeamBlackboardService_writeBestTeamEnemyFactToBlackboard00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: writeBestTeamFactToBlackboard of class  TeamBlackboardService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TeamBlackboardService_writeBestTeamFactToBlackboard00
static int tolua_SandboxToLua_TeamBlackboardService_writeBestTeamFactToBlackboard00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  const std::string keyPrefix = ((const std::string)  tolua_tocppstring(tolua_S,4,0));
  bool allowOwnReport = ((bool)  tolua_toboolean(tolua_S,5,true));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'writeBestTeamFactToBlackboard'", NULL);
#endif
  {
   bool tolua_ret = (bool)  self->writeBestTeamFactToBlackboard(agent,factType,keyPrefix,allowOwnReport);
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
   tolua_pushcppstring(tolua_S,(const char*)factType);
   tolua_pushcppstring(tolua_S,(const char*)keyPrefix);
  }
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'writeBestTeamFactToBlackboard'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: getTeamBlackboardReportCount of class  TeamBlackboardService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TeamBlackboardService_getTeamBlackboardReportCount00
static int tolua_SandboxToLua_TeamBlackboardService_getTeamBlackboardReportCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTeamBlackboardEnemyFactCount of class  TeamBlackboardService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TeamBlackboardService_getTeamBlackboardEnemyFactCount00
static int tolua_SandboxToLua_TeamBlackboardService_getTeamBlackboardEnemyFactCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const TeamBlackboardService* self = (const TeamBlackboardService*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getTeamBlackboardEnemyFactCount'", NULL);
#endif
  {
   int tolua_ret = (int)  self->getTeamBlackboardEnemyFactCount();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getTeamBlackboardEnemyFactCount'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getTeamBlackboardTypedFactCount of class  TeamBlackboardService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TeamBlackboardService_getTeamBlackboardTypedFactCount00
static int tolua_SandboxToLua_TeamBlackboardService_getTeamBlackboardTypedFactCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const TeamBlackboardService* self = (const TeamBlackboardService*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getTeamBlackboardTypedFactCount'", NULL);
#endif
  {
   int tolua_ret = (int)  self->getTeamBlackboardTypedFactCount();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getTeamBlackboardTypedFactCount'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getTeamBlackboardTypedReportCount of class  TeamBlackboardService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TeamBlackboardService_getTeamBlackboardTypedReportCount00
static int tolua_SandboxToLua_TeamBlackboardService_getTeamBlackboardTypedReportCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const TeamBlackboardService* self = (const TeamBlackboardService*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getTeamBlackboardTypedReportCount'", NULL);
#endif
  {
   int tolua_ret = (int)  self->getTeamBlackboardTypedReportCount();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getTeamBlackboardTypedReportCount'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: buildTeamBlackboardDebugSummary of class  TeamBlackboardService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TeamBlackboardService_buildTeamBlackboardDebugSummary00
static int tolua_SandboxToLua_TeamBlackboardService_buildTeamBlackboardDebugSummary00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: clearTacticalInfluence of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_clearTacticalInfluence00
static int tolua_SandboxToLua_TacticalService_clearTacticalInfluence00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: configureTacticalInfluence of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_configureTacticalInfluence00
static int tolua_SandboxToLua_TacticalService_configureTacticalInfluence00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: configureTacticalInfluenceFromNavMesh of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_configureTacticalInfluenceFromNavMesh00
static int tolua_SandboxToLua_TacticalService_configureTacticalInfluenceFromNavMesh00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: configureTacticalInfluenceLayerUpdate of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_configureTacticalInfluenceLayerUpdate00
static int tolua_SandboxToLua_TacticalService_configureTacticalInfluenceLayerUpdate00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  int intervalMs = ((int)  tolua_tonumber(tolua_S,3,0));
  bool dirtyOnly = ((bool)  tolua_toboolean(tolua_S,4,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'configureTacticalInfluenceLayerUpdate'", NULL);
#endif
  {
   self->configureTacticalInfluenceLayerUpdate(layerName,intervalMs,dirtyOnly);
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'configureTacticalInfluenceLayerUpdate'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: markTacticalInfluenceLayerDirty of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_markTacticalInfluenceLayerDirty00
static int tolua_SandboxToLua_TacticalService_markTacticalInfluenceLayerDirty00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  const std::string layerName = ((const std::string)  tolua_tocppstring(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'markTacticalInfluenceLayerDirty'", NULL);
#endif
  {
   self->markTacticalInfluenceLayerDirty(layerName);
   tolua_pushcppstring(tolua_S,(const char*)layerName);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'markTacticalInfluenceLayerDirty'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: configureTacticalQueryCandidateLimit of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_configureTacticalQueryCandidateLimit00
static int tolua_SandboxToLua_TacticalService_configureTacticalQueryCandidateLimit00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
 ...
 {
  TacticalService* self = (TacticalService*)  tolua_tousertype(tolua_S,1,0);
  int maxCandidates = ((int)  tolua_tonumber(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'configureTacticalQueryCandidateLimit'", NULL);
#endif
  {
   self->configureTacticalQueryCandidateLimit(maxCandidates);
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'configureTacticalQueryCandidateLimit'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: getTacticalQueryCandidateLimit of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalQueryCandidateLimit00
static int tolua_SandboxToLua_TacticalService_getTacticalQueryCandidateLimit00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const TacticalService",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  const TacticalService* self = (const TacticalService*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'getTacticalQueryCandidateLimit'", NULL);
#endif
  {
   int tolua_ret = (int)  self->getTacticalQueryCandidateLimit();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getTacticalQueryCandidateLimit'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: clearTacticalInfluenceLayer of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_clearTacticalInfluenceLayer00
static int tolua_SandboxToLua_TacticalService_clearTacticalInfluenceLayer00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: setTacticalInfluenceLayerOptions of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_setTacticalInfluenceLayerOptions00
static int tolua_SandboxToLua_TacticalService_setTacticalInfluenceLayerOptions00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: addTacticalInfluenceSource of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_addTacticalInfluenceSource00
static int tolua_SandboxToLua_TacticalService_addTacticalInfluenceSource00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: addTacticalInfluencePoint of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_addTacticalInfluencePoint00
static int tolua_SandboxToLua_TacticalService_addTacticalInfluencePoint00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: spreadTacticalInfluenceLayer of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_spreadTacticalInfluenceLayer00
static int tolua_SandboxToLua_TacticalService_spreadTacticalInfluenceLayer00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: sampleTacticalInfluence of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_sampleTacticalInfluence00
static int tolua_SandboxToLua_TacticalService_sampleTacticalInfluence00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: scoreTacticalPosition of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_scoreTacticalPosition00
static int tolua_SandboxToLua_TacticalService_scoreTacticalPosition00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: findBestTacticalPosition of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_findBestTacticalPosition00
static int tolua_SandboxToLua_TacticalService_findBestTacticalPosition00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: scoreTacticalQueryPosition of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_scoreTacticalQueryPosition00
static int tolua_SandboxToLua_TacticalService_scoreTacticalQueryPosition00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: findBestTacticalQueryPosition of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_findBestTacticalQueryPosition00
static int tolua_SandboxToLua_TacticalService_findBestTacticalQueryPosition00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: findBestSupportPosition of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_findBestSupportPosition00
static int tolua_SandboxToLua_TacticalService_findBestSupportPosition00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: findLowThreatPosition of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_findLowThreatPosition00
static int tolua_SandboxToLua_TacticalService_findLowThreatPosition00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: configureTacticalEvents of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_configureTacticalEvents00
static int tolua_SandboxToLua_TacticalService_configureTacticalEvents00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: clearTacticalEvents of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_clearTacticalEvents00
static int tolua_SandboxToLua_TacticalService_clearTacticalEvents00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: publishTacticalEvent of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_publishTacticalEvent00
static int tolua_SandboxToLua_TacticalService_publishTacticalEvent00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalEventCount of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalEventCount00
static int tolua_SandboxToLua_TacticalService_getTacticalEventCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalEventTypeCount of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalEventTypeCount00
static int tolua_SandboxToLua_TacticalService_getTacticalEventTypeCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getLastTacticalEventPosition of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getLastTacticalEventPosition00
static int tolua_SandboxToLua_TacticalService_getLastTacticalEventPosition00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalEventDebugRecordCount of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalEventDebugRecordCount00
static int tolua_SandboxToLua_TacticalService_getTacticalEventDebugRecordCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalEventDebugType of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalEventDebugType00
static int tolua_SandboxToLua_TacticalService_getTacticalEventDebugType00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalEventDebugSenderId of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalEventDebugSenderId00
static int tolua_SandboxToLua_TacticalService_getTacticalEventDebugSenderId00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalEventDebugTargetId of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalEventDebugTargetId00
static int tolua_SandboxToLua_TacticalService_getTacticalEventDebugTargetId00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalEventDebugTeamId of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalEventDebugTeamId00
static int tolua_SandboxToLua_TacticalService_getTacticalEventDebugTeamId00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalEventDebugTargetTeamId of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalEventDebugTargetTeamId00
static int tolua_SandboxToLua_TacticalService_getTacticalEventDebugTargetTeamId00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalEventDebugPosition of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalEventDebugPosition00
static int tolua_SandboxToLua_TacticalService_getTacticalEventDebugPosition00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalEventDebugTimeMs of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalEventDebugTimeMs00
static int tolua_SandboxToLua_TacticalService_getTacticalEventDebugTimeMs00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalEventDebugRemainingTtlMs of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalEventDebugRemainingTtlMs00
static int tolua_SandboxToLua_TacticalService_getTacticalEventDebugRemainingTtlMs00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: rebuildTacticalDangerLayer of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_rebuildTacticalDangerLayer00
static int tolua_SandboxToLua_TacticalService_rebuildTacticalDangerLayer00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: rebuildTacticalTeamLayer of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_rebuildTacticalTeamLayer00
static int tolua_SandboxToLua_TacticalService_rebuildTacticalTeamLayer00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: rebuildTacticalObjectiveLayer of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_rebuildTacticalObjectiveLayer00
static int tolua_SandboxToLua_TacticalService_rebuildTacticalObjectiveLayer00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalInfluenceLayerActiveCellCount of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalInfluenceLayerActiveCellCount00
static int tolua_SandboxToLua_TacticalService_getTacticalInfluenceLayerActiveCellCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalInfluenceLayerCellWriteCount of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalInfluenceLayerCellWriteCount00
static int tolua_SandboxToLua_TacticalService_getTacticalInfluenceLayerCellWriteCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalInfluenceLayerDebugCellCount of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalInfluenceLayerDebugCellCount00
static int tolua_SandboxToLua_TacticalService_getTacticalInfluenceLayerDebugCellCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalInfluenceLayerDebugCellPosition of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalInfluenceLayerDebugCellPosition00
static int tolua_SandboxToLua_TacticalService_getTacticalInfluenceLayerDebugCellPosition00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalInfluenceLayerDebugCellValue of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalInfluenceLayerDebugCellValue00
static int tolua_SandboxToLua_TacticalService_getTacticalInfluenceLayerDebugCellValue00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: drawTacticalInfluenceLayer of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_drawTacticalInfluenceLayer00
static int tolua_SandboxToLua_TacticalService_drawTacticalInfluenceLayer00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: rebuildTacticalInfluenceLayerDebugVisual of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_rebuildTacticalInfluenceLayerDebugVisual00
static int tolua_SandboxToLua_TacticalService_rebuildTacticalInfluenceLayerDebugVisual00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: setTacticalInfluenceLayerDebugOrder of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_setTacticalInfluenceLayerDebugOrder00
static int tolua_SandboxToLua_TacticalService_setTacticalInfluenceLayerDebugOrder00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  TacticalService* self = (TacticalService*)  tolua_tousertype(tolua_S,1,0);
  const std::string layerName = ((const std::string)  tolua_tocppstring(tolua_S,2,0));
  int drawOrder = ((int)  tolua_tonumber(tolua_S,3,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'setTacticalInfluenceLayerDebugOrder'", NULL);
#endif
  {
   self->setTacticalInfluenceLayerDebugOrder(layerName,drawOrder);
   tolua_pushcppstring(tolua_S,(const char*)layerName);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'setTacticalInfluenceLayerDebugOrder'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: setTacticalInfluenceDebugVisible of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_setTacticalInfluenceDebugVisible00
static int tolua_SandboxToLua_TacticalService_setTacticalInfluenceDebugVisible00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: clearTacticalInfluenceDebugVisuals of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_clearTacticalInfluenceDebugVisuals00
static int tolua_SandboxToLua_TacticalService_clearTacticalInfluenceDebugVisuals00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalInfluenceActiveCellCount of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalInfluenceActiveCellCount00
static int tolua_SandboxToLua_TacticalService_getTacticalInfluenceActiveCellCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalInfluenceCellWriteCount of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalInfluenceCellWriteCount00
static int tolua_SandboxToLua_TacticalService_getTacticalInfluenceCellWriteCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: getTacticalInfluenceQueryCount of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_getTacticalInfluenceQueryCount00
static int tolua_SandboxToLua_TacticalService_getTacticalInfluenceQueryCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: buildTacticalInfluenceDebugSummary of class  TacticalService */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_TacticalService_buildTacticalInfluenceDebugSummary00
static int tolua_SandboxToLua_TacticalService_buildTacticalInfluenceDebugSummary00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: buildAiRuntimeDebugSummary of class  ObjectManager */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_ObjectManager_buildAiRuntimeDebugSummary00
static int tolua_SandboxToLua_ObjectManager_buildAiRuntimeDebugSummary00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'buildAiRuntimeDebugSummary'", NULL);
#endif
  {
   std::string tolua_ret = (std::string)  self->buildAiRuntimeDebugSummary(maxAgents);
   tolua_pushcppstring(tolua_S,(const char*)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'buildAiRuntimeDebugSummary'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: buildAiRuntimeDebugSummaryForAgent of class  ObjectManager */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_ObjectManager_buildAiRuntimeDebugSummaryForAgent00
static int tolua_SandboxToLua_ObjectManager_buildAiRuntimeDebugSummaryForAgent00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ObjectManager* self = (ObjectManager*)  tolua_tousertype(tolua_S,1,0);
  int maxAgents = ((int)  tolua_tonumber(tolua_S,2,0));
  int focusAgentId = ((int)  tolua_tonumber(tolua_S,3,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'buildAiRuntimeDebugSummaryForAgent'", NULL);
#endif
  {
   std::string tolua_ret = (std::string)  self->buildAiRuntimeDebugSummaryForAgent(maxAgents,focusAgentId);
   tolua_pushcppstring(tolua_S,(const char*)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'buildAiRuntimeDebugSummaryForAgent'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: buildAiDebugSummaryForAgent of class  ObjectManager */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_ObjectManager_buildAiDebugSummaryForAgent00
static int tolua_SandboxToLua_ObjectManager_buildAiDebugSummaryForAgent00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  int focusAgentId = ((int)  tolua_tonumber(tolua_S,3,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'buildAiDebugSummaryForAgent'", NULL);
#endif
  {
   std::string tolua_ret = (std::string)  self->buildAiDebugSummaryForAgent(maxAgents,focusAgentId);
   tolua_pushcppstring(tolua_S,(const char*)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'buildAiDebugSummaryForAgent'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: GetRevision of class  Blackboard */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_Blackboard_GetRevision00
static int tolua_SandboxToLua_Blackboard_GetRevision00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const Blackboard* self = (const Blackboard*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'GetRevision'", NULL);
#endif
  {
   int tolua_ret = (int)  self->GetRevision();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'GetRevision'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: GetKeyRevision of class  Blackboard */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_Blackboard_GetKeyRevision00
static int tolua_SandboxToLua_Blackboard_GetKeyRevision00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  const std::string key = ((const std::string)  tolua_tocppstring(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'GetKeyRevision'", NULL);
#endif
  {
   int tolua_ret = (int)  self->GetKeyRevision(key);
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
   tolua_pushcppstring(tolua_S,(const char*)key);
  }
 }
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'GetKeyRevision'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
/* method: GetAgentOwner of class  LuaDecisionAction */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_LuaDecisionAction_GetAgentOwner00
static int tolua_SandboxToLua_LuaDecisionAction_GetAgentOwner00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetAgentOwner of class  DecisionTreeDriver */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_DecisionTreeDriver_GetAgentOwner00
static int tolua_SandboxToLua_DecisionTreeDriver_GetAgentOwner00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: GetAgentOwner of class  LuaBehaviorAction */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_LuaBehaviorAction_GetAgentOwner00
static int tolua_SandboxToLua_LuaBehaviorAction_GetAgentOwner00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: SetResultCacheEnabled of class  LuaCondition */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_LuaCondition_SetResultCacheEnabled00
static int tolua_SandboxToLua_LuaCondition_SetResultCacheEnabled00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"LuaCondition",0,&tolua_err) ||
     !tolua_isboolean(tolua_S,2,0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,3,&tolua_err)
 )
  goto tolua_lerror;
...
#endif
 {
  ...
  bool enabled = ((bool)  tolua_toboolean(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'SetResultCacheEnabled'", NULL);
#endif
  {
   self->SetResultCacheEnabled(enabled);
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'SetResultCacheEnabled'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: IsResultCacheEnabled of class  LuaCondition */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_LuaCondition_IsResultCacheEnabled00
static int tolua_SandboxToLua_LuaCondition_IsResultCacheEnabled00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"const LuaCondition",0,&tolua_err) ||
     !tolua_isnoobj(tolua_S,2,&tolua_err)
 )
  goto tolua_lerror;
 else
#endif
 {
  const LuaCondition* self = (const LuaCondition*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'IsResultCacheEnabled'", NULL);
#endif
  {
   bool tolua_ret = (bool)  self->IsResultCacheEnabled();
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'IsResultCacheEnabled'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: SetResultCacheTtlMs of class  LuaCondition */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_LuaCondition_SetResultCacheTtlMs00
static int tolua_SandboxToLua_LuaCondition_SetResultCacheTtlMs00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
 ...
 {
  LuaCondition* self = (LuaCondition*)  tolua_tousertype(tolua_S,1,0);
  float ttlMs = ((float)  tolua_tonumber(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'SetResultCacheTtlMs'", NULL);
#endif
  {
   self->SetResultCacheTtlMs(ttlMs);
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'SetResultCacheTtlMs'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: GetResultCacheTtlMs of class  LuaCondition */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_LuaCondition_GetResultCacheTtlMs00
static int tolua_SandboxToLua_LuaCondition_GetResultCacheTtlMs00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const LuaCondition* self = (const LuaCondition*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'GetResultCacheTtlMs'", NULL);
#endif
  {
   float tolua_ret = (float)  self->GetResultCacheTtlMs();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'GetResultCacheTtlMs'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: AddResultCacheDependencyKey of class  LuaCondition */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_LuaCondition_AddResultCacheDependencyKey00
static int tolua_SandboxToLua_LuaCondition_AddResultCacheDependencyKey00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  const std::string key = ((const std::string)  tolua_tocppstring(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'AddResultCacheDependencyKey'", NULL);
#endif
  {
   self->AddResultCacheDependencyKey(key);
   tolua_pushcppstring(tolua_S,(const char*)key);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'AddResultCacheDependencyKey'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: ClearResultCacheDependencyKeys of class  LuaCondition */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_LuaCondition_ClearResultCacheDependencyKeys00
static int tolua_SandboxToLua_LuaCondition_ClearResultCacheDependencyKeys00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  LuaCondition* self = (LuaCondition*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'ClearResultCacheDependencyKeys'", NULL);
#endif
  {
   self->ClearResultCacheDependencyKeys();
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'ClearResultCacheDependencyKeys'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: GetResultCacheDependencyCount of class  LuaCondition */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_LuaCondition_GetResultCacheDependencyCount00
static int tolua_SandboxToLua_LuaCondition_GetResultCacheDependencyCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const LuaCondition* self = (const LuaCondition*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'GetResultCacheDependencyCount'", NULL);
#endif
  {
   int tolua_ret = (int)  self->GetResultCacheDependencyCount();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'GetResultCacheDependencyCount'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: GetResultCacheHitCount of class  LuaCondition */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_LuaCondition_GetResultCacheHitCount00
static int tolua_SandboxToLua_LuaCondition_GetResultCacheHitCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const LuaCondition* self = (const LuaCondition*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'GetResultCacheHitCount'", NULL);
#endif
  {
   int tolua_ret = (int)  self->GetResultCacheHitCount();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'GetResultCacheHitCount'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: GetResultCacheInvalidatedCount of class  LuaCondition */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_LuaCondition_GetResultCacheInvalidatedCount00
static int tolua_SandboxToLua_LuaCondition_GetResultCacheInvalidatedCount00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const LuaCondition* self = (const LuaCondition*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'GetResultCacheInvalidatedCount'", NULL);
#endif
  {
   int tolua_ret = (int)  self->GetResultCacheInvalidatedCount();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'GetResultCacheInvalidatedCount'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: GetAgentOwner of class  BehaviorTreeDriver */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_BehaviorTreeDriver_GetAgentOwner00
static int tolua_SandboxToLua_BehaviorTreeDriver_GetAgentOwner00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: SetDebugTraceSampleInterval of class  BehaviorTreeDriver */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_BehaviorTreeDriver_SetDebugTraceSampleInterval00
static int tolua_SandboxToLua_BehaviorTreeDriver_SetDebugTraceSampleInterval00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'SetDebugTraceSampleInterval'", NULL);
#endif
  {
   self->SetDebugTraceSampleInterval(interval);
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'SetDebugTraceSampleInterval'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: GetDebugTraceSampleInterval of class  BehaviorTreeDriver */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_BehaviorTreeDriver_GetDebugTraceSampleInterval00
static int tolua_SandboxToLua_BehaviorTreeDriver_GetDebugTraceSampleInterval00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const BehaviorTreeDriver* self = (const BehaviorTreeDriver*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'GetDebugTraceSampleInterval'", NULL);
#endif
  {
   int tolua_ret = (int)  self->GetDebugTraceSampleInterval();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'GetDebugTraceSampleInterval'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: SetRuntimeTickIntervalMs of class  BehaviorTreeDriver */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_BehaviorTreeDriver_SetRuntimeTickIntervalMs00
static int tolua_SandboxToLua_BehaviorTreeDriver_SetRuntimeTickIntervalMs00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
 ...
 {
  BehaviorTreeDriver* self = (BehaviorTreeDriver*)  tolua_tousertype(tolua_S,1,0);
  float intervalMs = ((float)  tolua_tonumber(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'SetRuntimeTickIntervalMs'", NULL);
#endif
  {
   self->SetRuntimeTickIntervalMs(intervalMs);
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'SetRuntimeTickIntervalMs'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: GetRuntimeTickIntervalMs of class  BehaviorTreeDriver */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_BehaviorTreeDriver_GetRuntimeTickIntervalMs00
static int tolua_SandboxToLua_BehaviorTreeDriver_GetRuntimeTickIntervalMs00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const BehaviorTreeDriver* self = (const BehaviorTreeDriver*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'GetRuntimeTickIntervalMs'", NULL);
#endif
  {
   float tolua_ret = (float)  self->GetRuntimeTickIntervalMs();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'GetRuntimeTickIntervalMs'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: SetRuntimeTickStaggerEnabled of class  BehaviorTreeDriver */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_BehaviorTreeDriver_SetRuntimeTickStaggerEnabled00
static int tolua_SandboxToLua_BehaviorTreeDriver_SetRuntimeTickStaggerEnabled00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  bool enabled = ((bool)  tolua_toboolean(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'SetRuntimeTickStaggerEnabled'", NULL);
#endif
  {
   self->SetRuntimeTickStaggerEnabled(enabled);
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'SetRuntimeTickStaggerEnabled'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: IsRuntimeTickStaggerEnabled of class  BehaviorTreeDriver */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_BehaviorTreeDriver_IsRuntimeTickStaggerEnabled00
static int tolua_SandboxToLua_BehaviorTreeDriver_IsRuntimeTickStaggerEnabled00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const BehaviorTreeDriver* self = (const BehaviorTreeDriver*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'IsRuntimeTickStaggerEnabled'", NULL);
#endif
  {
   bool tolua_ret = (bool)  self->IsRuntimeTickStaggerEnabled();
   tolua_pushboolean(tolua_S,(bool)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'IsRuntimeTickStaggerEnabled'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_SandboxToLua_BehaviorTreeDriver_SetRuntimeMaxTreeTicksPerFrame00(lua_State* tolua_S)
{
 ...
 {
  BehaviorTreeDriver* self = (BehaviorTreeDriver*)  tolua_tousertype(tolua_S,1,0);
  int maxTicksPerFrame = ((int)  tolua_tonumber(tolua_S,2,0));
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'SetRuntimeMaxTreeTicksPerFrame'", NULL);
#endif
  {
   self->SetRuntimeMaxTreeTicksPerFrame(maxTicksPerFrame);
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'SetRuntimeMaxTreeTicksPerFrame'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* method: GetRuntimeMaxTreeTicksPerFrame of class  BehaviorTreeDriver */
#ifndef TOLUA_DISABLE_tolua_SandboxToLua_BehaviorTreeDriver_GetRuntimeMaxTreeTicksPerFrame00
static int tolua_SandboxToLua_BehaviorTreeDriver_GetRuntimeMaxTreeTicksPerFrame00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  const BehaviorTreeDriver* self = (const BehaviorTreeDriver*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
  if (!self) tolua_error(tolua_S,"invalid 'self' in function 'GetRuntimeMaxTreeTicksPerFrame'", NULL);
#endif
  {
   int tolua_ret = (int)  self->GetRuntimeMaxTreeTicksPerFrame();
   tolua_pushnumber(tolua_S,(lua_Number)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'GetRuntimeMaxTreeTicksPerFrame'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_SandboxToLua_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S,"AgentConfigService","AgentConfigService","",NULL);
  tolua_beginmodule(tolua_S,"AgentConfigService");
   tolua_function(tolua_S,"SetUseCppFsmFlag",tolua_SandboxToLua_AgentConfigService_SetUseCppFsmFlag00);
   tolua_function(tolua_S,"GetUseCppFsmFlag",tolua_SandboxToLua_AgentConfigService_GetUseCppFsmFlag00);
  tolua_endmodule(tolua_S);
  ...
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S,"NavigationService","NavigationService","",NULL);
  tolua_beginmodule(tolua_S,"NavigationService");
   tolua_function(tolua_S,"DefaultConfig",tolua_SandboxToLua_NavigationService_DefaultConfig00);
   tolua_function(tolua_S,"ApplySettingConfig",tolua_SandboxToLua_NavigationService_ApplySettingConfig00);
   tolua_function(tolua_S,"CreateNavigationMesh",tolua_SandboxToLua_NavigationService_CreateNavigationMesh00);
   tolua_function(tolua_S,"RandomPoint",tolua_SandboxToLua_NavigationService_RandomPoint00);
   tolua_function(tolua_S,"FindClosestPoint",tolua_SandboxToLua_NavigationService_FindClosestPoint00);
   tolua_function(tolua_S,"FindPath",tolua_SandboxToLua_NavigationService_FindPath00);
  tolua_endmodule(tolua_S);
  ...
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S,"ScriptService","ScriptService","",NULL);
  tolua_beginmodule(tolua_S,"ScriptService");
   tolua_function(tolua_S,"CallFile",tolua_SandboxToLua_ScriptService_CallFile00);
  tolua_endmodule(tolua_S);
  ...
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S,"AgentLocomotion","AgentLocomotion","IComponent",NULL);
  tolua_beginmodule(tolua_S,"AgentLocomotion");
   tolua_function(tolua_S,"SetPosition",tolua_SandboxToLua_AgentLocomotion_SetPosition00);
   tolua_function(tolua_S,"GetPosition",tolua_SandboxToLua_AgentLocomotion_GetPosition00);
   tolua_function(tolua_S,"SetMass",tolua_SandboxToLua_AgentLocomotion_SetMass00);
   tolua_function(tolua_S,"SetHeight",tolua_SandboxToLua_AgentLocomotion_SetHeight00);
   tolua_function(tolua_S,"SetRadius",tolua_SandboxToLua_AgentLocomotion_SetRadius00);
   tolua_function(tolua_S,"SetSpeed",tolua_SandboxToLua_AgentLocomotion_SetSpeed00);
   tolua_function(tolua_S,"SetMaxForce",tolua_SandboxToLua_AgentLocomotion_SetMaxForce00);
   tolua_function(tolua_S,"SetMaxSpeed",tolua_SandboxToLua_AgentLocomotion_SetMaxSpeed00);
   tolua_function(tolua_S,"GetMass",tolua_SandboxToLua_AgentLocomotion_GetMass00);
   tolua_function(tolua_S,"GetSpeed",tolua_SandboxToLua_AgentLocomotion_GetSpeed00);
   tolua_function(tolua_S,"GetHeight",tolua_SandboxToLua_AgentLocomotion_GetHeight00);
   tolua_function(tolua_S,"GetRadius",tolua_SandboxToLua_AgentLocomotion_GetRadius00);
   ...
   tolua_function(tolua_S,"GetTargetRadius",tolua_SandboxToLua_AgentLocomotion_GetTargetRadius00);
   tolua_function(tolua_S,"GetTarget",tolua_SandboxToLua_AgentLocomotion_GetTarget00);
   tolua_function(tolua_S,"GetVelocity",tolua_SandboxToLua_AgentLocomotion_GetVelocity00);
   tolua_function(tolua_S,"GetUp",tolua_SandboxToLua_AgentLocomotion_GetUp00);
   tolua_function(tolua_S,"GetLeft",tolua_SandboxToLua_AgentLocomotion_GetLeft00);
   tolua_function(tolua_S,"GetForward",tolua_SandboxToLua_AgentLocomotion_GetForward00);
   tolua_function(tolua_S,"SetPath",tolua_SandboxToLua_AgentLocomotion_SetPath00);
   tolua_function(tolua_S,"GetPath",tolua_SandboxToLua_AgentLocomotion_GetPath00);
   tolua_function(tolua_S,"HasPath",tolua_SandboxToLua_AgentLocomotion_HasPath00);
   tolua_function(tolua_S,"IsPathCyclic",tolua_SandboxToLua_AgentLocomotion_IsPathCyclic00);
   tolua_function(tolua_S,"GetDistanceAlongPath",tolua_SandboxToLua_AgentLocomotion_GetDistanceAlongPath00);
   tolua_function(tolua_S,"GetNearestPointOnPath",tolua_SandboxToLua_AgentLocomotion_GetNearestPointOnPath00);
   tolua_function(tolua_S,"GetPointOnPath",tolua_SandboxToLua_AgentLocomotion_GetPointOnPath00);
   tolua_function(tolua_S,"ForceToPosition",tolua_SandboxToLua_AgentLocomotion_ForceToPosition00);
   tolua_function(tolua_S,"ForceToFollowPath",tolua_SandboxToLua_AgentLocomotion_ForceToFollowPath00);
   tolua_function(tolua_S,"ForceToStayOnPath",tolua_SandboxToLua_AgentLocomotion_ForceToStayOnPath00);
   tolua_function(tolua_S,"ForceToWander",tolua_SandboxToLua_AgentLocomotion_ForceToWander00);
   tolua_function(tolua_S,"ForceToTargetSpeed",tolua_SandboxToLua_AgentLocomotion_ForceToTargetSpeed00);
   tolua_function(tolua_S,"ForceToAvoidAgents",tolua_SandboxToLua_AgentLocomotion_ForceToAvoidAgents00);
   tolua_function(tolua_S,"ForceToAvoidObjects",tolua_SandboxToLua_AgentLocomotion_ForceToAvoidObjects00);
   tolua_function(tolua_S,"ForceToCombine",tolua_SandboxToLua_AgentLocomotion_ForceToCombine00);
   tolua_function(tolua_S,"ForceToSeparate",tolua_SandboxToLua_AgentLocomotion_ForceToSeparate00);
   tolua_function(tolua_S,"ApplyForce",tolua_SandboxToLua_AgentLocomotion_ApplyForce00);
  tolua_endmodule(tolua_S);
  ...
  tolua_beginmodule(tolua_S,"AnimComponent");
   ...
   tolua_function(tolua_S,"EnterReloadIntent",tolua_SandboxToLua_AnimComponent_EnterReloadIntent00);
   tolua_function(tolua_S,"EnterDeathIntent",tolua_SandboxToLua_AnimComponent_EnterDeathIntent00);
  tolua_endmodule(tolua_S);
  ...
  tolua_beginmodule(tolua_S,"BaseObject");
   ...
   tolua_function(tolua_S,"GetLocomotionComponent",tolua_SandboxToLua_BaseObject_GetLocomotionComponent00);
  tolua_endmodule(tolua_S);
  ...
  tolua_beginmodule(tolua_S,"ObjectFactory");
   ...
   tolua_function(tolua_S,"CreateVisualPlane",tolua_SandboxToLua_ObjectFactory_CreateVisualPlane00);
  ...
  tolua_beginmodule(tolua_S,"AIScheduler");
   tolua_function(tolua_S,"configureAiScheduler",tolua_SandboxToLua_AIScheduler_configureAiScheduler00);
   tolua_function(tolua_S,"buildAiSchedulerDebugSummary",tolua_SandboxToLua_AIScheduler_buildAiSchedulerDebugSummary00);
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S,"AgentPerceptionSystem","AgentPerceptionSystem","",NULL);
  tolua_beginmodule(tolua_S,"AgentPerceptionSystem");
   tolua_function(tolua_S,"configureHearingDangerSense",tolua_SandboxToLua_AgentPerceptionSystem_configureHearingDangerSense00);
   tolua_function(tolua_S,"clearHearingDangerSense",tolua_SandboxToLua_AgentPerceptionSystem_clearHearingDangerSense00);
   tolua_function(tolua_S,"publishHearingDangerEvent",tolua_SandboxToLua_AgentPerceptionSystem_publishHearingDangerEvent00);
   tolua_function(tolua_S,"getHearingDangerEventCount",tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerEventCount00);
   tolua_function(tolua_S,"getHearingDangerPublishedEventCount",tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerPublishedEventCount00);
   tolua_function(tolua_S,"getHearingDangerPrunedEventCount",tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerPrunedEventCount00);
   tolua_function(tolua_S,"getHearingDangerRunCount",tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerRunCount00);
   tolua_function(tolua_S,"getHearingDangerSkipCount",tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerSkipCount00);
   tolua_function(tolua_S,"getHearingDangerAgentCheckCount",tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerAgentCheckCount00);
   tolua_function(tolua_S,"getHearingDangerHeardResponseCount",tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerHeardResponseCount00);
   tolua_function(tolua_S,"getHearingDangerDangerResponseCount",tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerDangerResponseCount00);
   tolua_function(tolua_S,"getHearingDangerInvestigationCount",tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerInvestigationCount00);
   tolua_function(tolua_S,"getHearingDangerRetreatFactApplyCount",tolua_SandboxToLua_AgentPerceptionSystem_getHearingDangerRetreatFactApplyCount00);
   tolua_function(tolua_S,"buildPerceptionDebugSummary",tolua_SandboxToLua_AgentPerceptionSystem_buildPerceptionDebugSummary00);
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S,"TeamBlackboardService","TeamBlackboardService","",NULL);
  tolua_beginmodule(tolua_S,"TeamBlackboardService");
   ...
   tolua_function(tolua_S,"getTeamBlackboardTypedFactCount",tolua_SandboxToLua_TeamBlackboardService_getTeamBlackboardTypedFactCount00);
   tolua_function(tolua_S,"getTeamBlackboardTypedReportCount",tolua_SandboxToLua_TeamBlackboardService_getTeamBlackboardTypedReportCount00);
   tolua_function(tolua_S,"buildTeamBlackboardDebugSummary",tolua_SandboxToLua_TeamBlackboardService_buildTeamBlackboardDebugSummary00);
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S,"TacticalService","TacticalService","",NULL);
  tolua_beginmodule(tolua_S,"TacticalService");
   tolua_function(tolua_S,"clearTacticalInfluence",tolua_SandboxToLua_TacticalService_clearTacticalInfluence00);
   tolua_function(tolua_S,"configureTacticalInfluence",tolua_SandboxToLua_TacticalService_configureTacticalInfluence00);
   tolua_function(tolua_S,"configureTacticalInfluenceFromNavMesh",tolua_SandboxToLua_TacticalService_configureTacticalInfluenceFromNavMesh00);
   tolua_function(tolua_S,"configureTacticalInfluenceLayerUpdate",tolua_SandboxToLua_TacticalService_configureTacticalInfluenceLayerUpdate00);
   tolua_function(tolua_S,"markTacticalInfluenceLayerDirty",tolua_SandboxToLua_TacticalService_markTacticalInfluenceLayerDirty00);
   tolua_function(tolua_S,"configureTacticalQueryCandidateLimit",tolua_SandboxToLua_TacticalService_configureTacticalQueryCandidateLimit00);
   tolua_function(tolua_S,"getTacticalQueryCandidateLimit",tolua_SandboxToLua_TacticalService_getTacticalQueryCandidateLimit00);
   tolua_function(tolua_S,"clearTacticalInfluenceLayer",tolua_SandboxToLua_TacticalService_clearTacticalInfluenceLayer00);
   tolua_function(tolua_S,"setTacticalInfluenceLayerOptions",tolua_SandboxToLua_TacticalService_setTacticalInfluenceLayerOptions00);
   tolua_function(tolua_S,"addTacticalInfluenceSource",tolua_SandboxToLua_TacticalService_addTacticalInfluenceSource00);
   tolua_function(tolua_S,"addTacticalInfluencePoint",tolua_SandboxToLua_TacticalService_addTacticalInfluencePoint00);
   tolua_function(tolua_S,"spreadTacticalInfluenceLayer",tolua_SandboxToLua_TacticalService_spreadTacticalInfluenceLayer00);
   tolua_function(tolua_S,"sampleTacticalInfluence",tolua_SandboxToLua_TacticalService_sampleTacticalInfluence00);
   tolua_function(tolua_S,"scoreTacticalPosition",tolua_SandboxToLua_TacticalService_scoreTacticalPosition00);
   tolua_function(tolua_S,"findBestTacticalPosition",tolua_SandboxToLua_TacticalService_findBestTacticalPosition00);
   tolua_function(tolua_S,"scoreTacticalQueryPosition",tolua_SandboxToLua_TacticalService_scoreTacticalQueryPosition00);
   tolua_function(tolua_S,"findBestTacticalQueryPosition",tolua_SandboxToLua_TacticalService_findBestTacticalQueryPosition00);
   tolua_function(tolua_S,"findBestSupportPosition",tolua_SandboxToLua_TacticalService_findBestSupportPosition00);
   tolua_function(tolua_S,"findLowThreatPosition",tolua_SandboxToLua_TacticalService_findLowThreatPosition00);
   tolua_function(tolua_S,"configureTacticalEvents",tolua_SandboxToLua_TacticalService_configureTacticalEvents00);
   tolua_function(tolua_S,"clearTacticalEvents",tolua_SandboxToLua_TacticalService_clearTacticalEvents00);
   tolua_function(tolua_S,"publishTacticalEvent",tolua_SandboxToLua_TacticalService_publishTacticalEvent00);
   tolua_function(tolua_S,"getTacticalEventCount",tolua_SandboxToLua_TacticalService_getTacticalEventCount00);
   tolua_function(tolua_S,"getTacticalEventTypeCount",tolua_SandboxToLua_TacticalService_getTacticalEventTypeCount00);
   tolua_function(tolua_S,"getLastTacticalEventPosition",tolua_SandboxToLua_TacticalService_getLastTacticalEventPosition00);
   tolua_function(tolua_S,"getTacticalEventDebugRecordCount",tolua_SandboxToLua_TacticalService_getTacticalEventDebugRecordCount00);
   tolua_function(tolua_S,"getTacticalEventDebugType",tolua_SandboxToLua_TacticalService_getTacticalEventDebugType00);
   tolua_function(tolua_S,"getTacticalEventDebugSenderId",tolua_SandboxToLua_TacticalService_getTacticalEventDebugSenderId00);
   tolua_function(tolua_S,"getTacticalEventDebugTargetId",tolua_SandboxToLua_TacticalService_getTacticalEventDebugTargetId00);
   tolua_function(tolua_S,"getTacticalEventDebugTeamId",tolua_SandboxToLua_TacticalService_getTacticalEventDebugTeamId00);
   tolua_function(tolua_S,"getTacticalEventDebugTargetTeamId",tolua_SandboxToLua_TacticalService_getTacticalEventDebugTargetTeamId00);
   tolua_function(tolua_S,"getTacticalEventDebugPosition",tolua_SandboxToLua_TacticalService_getTacticalEventDebugPosition00);
   tolua_function(tolua_S,"getTacticalEventDebugTimeMs",tolua_SandboxToLua_TacticalService_getTacticalEventDebugTimeMs00);
   tolua_function(tolua_S,"getTacticalEventDebugRemainingTtlMs",tolua_SandboxToLua_TacticalService_getTacticalEventDebugRemainingTtlMs00);
   tolua_function(tolua_S,"rebuildTacticalDangerLayer",tolua_SandboxToLua_TacticalService_rebuildTacticalDangerLayer00);
   tolua_function(tolua_S,"rebuildTacticalTeamLayer",tolua_SandboxToLua_TacticalService_rebuildTacticalTeamLayer00);
   tolua_function(tolua_S,"rebuildTacticalObjectiveLayer",tolua_SandboxToLua_TacticalService_rebuildTacticalObjectiveLayer00);
   tolua_function(tolua_S,"getTacticalInfluenceLayerActiveCellCount",tolua_SandboxToLua_TacticalService_getTacticalInfluenceLayerActiveCellCount00);
   tolua_function(tolua_S,"getTacticalInfluenceLayerCellWriteCount",tolua_SandboxToLua_TacticalService_getTacticalInfluenceLayerCellWriteCount00);
   tolua_function(tolua_S,"getTacticalInfluenceLayerDebugCellCount",tolua_SandboxToLua_TacticalService_getTacticalInfluenceLayerDebugCellCount00);
   tolua_function(tolua_S,"getTacticalInfluenceLayerDebugCellPosition",tolua_SandboxToLua_TacticalService_getTacticalInfluenceLayerDebugCellPosition00);
   ...
   tolua_function(tolua_S,"getTacticalInfluenceActiveCellCount",tolua_SandboxToLua_TacticalService_getTacticalInfluenceActiveCellCount00);
   tolua_function(tolua_S,"getTacticalInfluenceCellWriteCount",tolua_SandboxToLua_TacticalService_getTacticalInfluenceCellWriteCount00);
   tolua_function(tolua_S,"getTacticalInfluenceQueryCount",tolua_SandboxToLua_TacticalService_getTacticalInfluenceQueryCount00);
   tolua_function(tolua_S,"buildTacticalInfluenceDebugSummary",tolua_SandboxToLua_TacticalService_buildTacticalInfluenceDebugSummary00);
  tolua_endmodule(tolua_S);
  ...
  tolua_beginmodule(tolua_S,"ObjectManager");
   ...
   tolua_function(tolua_S,"buildAiRuntimeDebugSummary",tolua_SandboxToLua_ObjectManager_buildAiRuntimeDebugSummary00);
   tolua_function(tolua_S,"buildAiRuntimeDebugSummaryForAgent",tolua_SandboxToLua_ObjectManager_buildAiRuntimeDebugSummaryForAgent00);
   tolua_function(tolua_S,"buildAiDebugSummary",tolua_SandboxToLua_ObjectManager_buildAiDebugSummary00);
   tolua_function(tolua_S,"buildAiDebugSummaryForAgent",tolua_SandboxToLua_ObjectManager_buildAiDebugSummaryForAgent00);
  ...
  tolua_beginmodule(tolua_S,"Blackboard");
   ...
   tolua_function(tolua_S,"GetRevision",tolua_SandboxToLua_Blackboard_GetRevision00);
   tolua_function(tolua_S,"GetKeyRevision",tolua_SandboxToLua_Blackboard_GetKeyRevision00);
  tolua_endmodule(tolua_S);
  ...
  tolua_beginmodule(tolua_S,"LuaDecisionAction");
   ...
   tolua_function(tolua_S,"GetAgentOwner",tolua_SandboxToLua_LuaDecisionAction_GetAgentOwner00);
  tolua_endmodule(tolua_S);
  ...
  tolua_beginmodule(tolua_S,"DecisionTreeDriver");
   tolua_function(tolua_S,"GetAgentOwner",tolua_SandboxToLua_DecisionTreeDriver_GetAgentOwner00);
  ...
  tolua_beginmodule(tolua_S,"LuaBehaviorAction");
   ...
   tolua_function(tolua_S,"GetAgentOwner",tolua_SandboxToLua_LuaBehaviorAction_GetAgentOwner00);
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S,"LuaCondition","LuaCondition","BehaviorNode",NULL);
  tolua_beginmodule(tolua_S,"LuaCondition");
   tolua_function(tolua_S,"SetResultCacheEnabled",tolua_SandboxToLua_LuaCondition_SetResultCacheEnabled00);
   tolua_function(tolua_S,"IsResultCacheEnabled",tolua_SandboxToLua_LuaCondition_IsResultCacheEnabled00);
   tolua_function(tolua_S,"SetResultCacheTtlMs",tolua_SandboxToLua_LuaCondition_SetResultCacheTtlMs00);
   tolua_function(tolua_S,"GetResultCacheTtlMs",tolua_SandboxToLua_LuaCondition_GetResultCacheTtlMs00);
   tolua_function(tolua_S,"AddResultCacheDependencyKey",tolua_SandboxToLua_LuaCondition_AddResultCacheDependencyKey00);
   tolua_function(tolua_S,"ClearResultCacheDependencyKeys",tolua_SandboxToLua_LuaCondition_ClearResultCacheDependencyKeys00);
   tolua_function(tolua_S,"GetResultCacheDependencyCount",tolua_SandboxToLua_LuaCondition_GetResultCacheDependencyCount00);
   tolua_function(tolua_S,"GetResultCacheHitCount",tolua_SandboxToLua_LuaCondition_GetResultCacheHitCount00);
   tolua_function(tolua_S,"GetResultCacheInvalidatedCount",tolua_SandboxToLua_LuaCondition_GetResultCacheInvalidatedCount00);
  tolua_endmodule(tolua_S);
  ...
  tolua_beginmodule(tolua_S,"BehaviorTreeDriver");
   tolua_function(tolua_S,"GetAgentOwner",tolua_SandboxToLua_BehaviorTreeDriver_GetAgentOwner00);
   ...
   tolua_function(tolua_S,"SetDebugTraceSampleInterval",tolua_SandboxToLua_BehaviorTreeDriver_SetDebugTraceSampleInterval00);
   tolua_function(tolua_S,"GetDebugTraceSampleInterval",tolua_SandboxToLua_BehaviorTreeDriver_GetDebugTraceSampleInterval00);
   tolua_function(tolua_S,"SetRuntimeTickIntervalMs",tolua_SandboxToLua_BehaviorTreeDriver_SetRuntimeTickIntervalMs00);
