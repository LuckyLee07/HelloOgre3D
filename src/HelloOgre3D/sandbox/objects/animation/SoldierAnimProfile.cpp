...
namespace SoldierAnimProfile
{
	...
	std::string GetStateNameById(int stateId)
	{
	...
	int GetStateIdByName(const std::string& stateName)
	{
	...
	int ResolveBodyLocomotionState(int stanceType, SoldierLocomotionIntent locomotionIntent)
	{
	...
	int ResolveBodyActionState(int stanceType, SoldierActionIntent actionIntent)
	{
		switch (actionIntent)
		{
	...
	std::string ResolveWeaponState(SoldierActionIntent actionIntent, const std::string& currentWeaponState)
	{
	...
	void RegisterDefaultBodyNotifies(AgentAnimStateMachine& animStateMachine)
	{
