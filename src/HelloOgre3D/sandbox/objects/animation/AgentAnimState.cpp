...
AgentAnimState::AgentAnimState(const std::string& name, AgentAnim* animation, bool looping, float rate, int stateId)
	: m_stateId(stateId), m_looping(looping), m_rate(rate), m_stateName(name)
{
	m_pAnim = animation;
