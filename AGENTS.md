...
当前核心主轴：**把 AI 能力讲清楚、跑起来、看得见**。近期围绕感知、记忆、Blackboard、行为树 / 决策树 / FSM、团队通信、影响力地图、战术层、AI trace 与性能观测递进；同时要求新增能力尽量沉淀为生产级边界清晰、可维护、可验证的基础设施。
...
- **提交说明只写一行 subject**：`[dev]/[refactor]/[docs]<中文一句话>`。**不写 body。**
